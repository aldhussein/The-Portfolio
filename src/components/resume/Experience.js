...
const Experience = () => {
  return (
    <motion.div
      ...
      className="py-12 font-titleFont flex gap-20 sm:flex-col"
    >
      <div>
      ...
      <div>
        ...
        <div className="mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          <ResumeCard
            ...
            subTitle="Online Platforms (2019 - 2024)"
            result="Onlie"
            des="The training provided by Companies in order to prepare people to work in various sectors of the economy or areas of culture."
          />
          <ResumeCard
            title="Web Developer trainig"
            subTitle="Frontend Mentor (2019 - 2020)"
            result="Online"
          ...
          <ResumeCard
            ...
            subTitle="Ald Secondary School (2001 - 2010)"
            result="Somalia"
